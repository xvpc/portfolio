    ...
    return (
        <div ref={skillsRefs} className='container-fluid skills-container' id='skills'>
            <div className='container overflow-hidden d-flex flex-column flex-md-row justify-content-between align-items-center py-5 rounded gap-5'>
                ...
                <div className='skills-description move-items-top d-flex flex-column justify-content-center align-items-center align-items-md-start gap-3'>
                ...
                <div style={{maxWidth: '420px'}} className='skills-list flex-wrap w-100 move-items-bottom d-flex flex-row justify-content-center align-items-center gap-2'>
